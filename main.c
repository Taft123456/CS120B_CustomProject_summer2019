	...
	switch(Move_state)
	{
		...
		if (position != 1 && position != 17)
		{
			...
			else
			{
				...
				else if (lower_area[lower_scroll + position - 17] == 1)
				{
					if (lower_scroll + position - 17 == 16)
					{
						position = position;
					}
					else if (lower_scroll + position - 17 == 30)
					{
						position = position;
					}
					else if (lower_scroll + position - 17 == 44)
					{
						position = position;
					}
				}
		...
		if (!terminal)
		{
			if (position < 26)
			{
				...
				else
				{
					...
					else if (lower_area[lower_scroll + position - 15] == 1)
					{
						if (lower_scroll + position - 15 == 16)
						{
							position = position;
						}
						else if (lower_scroll + position - 15 == 30)
						{
							position = position;
						}
						else if (lower_scroll + position - 15 == 44)
						{
							position = position;
						}
					}
...
int main(void)
{
	...
	unsigned long int Moving_Period = 150;
	unsigned long int Jumping_Period = 150;
	unsigned long int Mapping_Period = 150;
	unsigned long int Evaluation_Period = 150;
	unsigned long int Shooting_Period = 150;
	unsigned long int Result_Period = 150;
